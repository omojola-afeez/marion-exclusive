    ...
    <footer className="bg-neutral-50 border-t border-neutral-200 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="font-semibold text-neutral-900 mb-4">Marion Exclusive</h3>
            <p className="text-sm text-neutral-600">
              Considered, well-made goods for a thoughtful lifestyle.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shop?category=apparel" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                  Apparel
                </Link>
              </li>
              <li>
                <Link href="/shop?category=accessories" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                  Accessories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shipping" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                  Shipping Info
                </Link>
              </li>
            </ul>
        ...
        {/* Newsletter */}
        <div className="border-t border-neutral-200 py-8 mb-8">
          <div className="max-w-md">
            <h3 className="font-medium text-neutral-900 mb-2">Stay in the Loop</h3>
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 px-4 py-2 border border-neutral-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-neutral-200 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-neutral-600">
            © {currentYear} Marion Exclusive. All rights reserved.
          </p>
          <div className="flex gap-6">
            ...
            <a href="#" className="text-neutral-600 hover:text-neutral-900 transition-colors">
              ...
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8.29 20c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-7.648 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
              </svg>
            </a>
            <a href="#" className="text-neutral-600 hover:text-neutral-900 transition-colors">
